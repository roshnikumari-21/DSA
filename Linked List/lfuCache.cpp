//check this practice this again...
//tc=O(1) for both the fucntion

//striver

//access krne pr v freq. increase hoti hai....
...
struct Node {
    ...
    Node* next;
    Node* prev;
    Node(int _key, int _value) {   //constructor
        key = _key;
        value = _value;
        cnt = 1;
    }
...
class LFUCache {
public:
    map<int, List*> freqMap;  // Frequency to List mapping
